#include "applyfriendpage.hxx"
#include "ui_applyfriendpage.h"
#include"tcpmgr.hxx"
#include"global.h"
#include"userdata.hxx"
#include<QRandomGenerator>
#include"applyfrienditem.hxx"
...
void ApplyFriendPage::AddNewApply(std::shared_ptr<AddlyFriendApply> apply)
{
    ...
    //收到审核好友信号
    connect(apply_item, &ApplyFriendItem::sig_auth_friend, [this,apply_item](std::shared_ptr<ApplyInfo> apply_info) {
