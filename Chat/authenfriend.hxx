#ifndef AUTHENFRIEND_HXX
#define AUTHENFRIEND_HXX
...
private:
    ...
    //已经创建好的标签
    QMap<QString, ClickedLabel*> _add_labels;//已经显示的标签
    std::vector<QString> _add_label_keys;//已经显示标签的下表
    QPoint _label_point;
    //用来在输入框显示添加新好友的标签
    QMap<QString, Friendlable*> _friend_labels;
    std::vector<QString> _friend_label_keys;
    void addLabel(QString name);
    std::vector<QString> _tip_data;//已经有的标签
    QPoint _tip_cur_point;//上次添加标签坐标
