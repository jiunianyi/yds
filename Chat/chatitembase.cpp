    ...
    , m_role(role)
{
    ...
    m_pIconLable->setScaledContents(true);
    m_pIconLable->setFixedSize(42, 42);
    ...
    if(m_role == ChatRole::self)
    {
        ...
        pGLayout->addWidget(m_pIconLable, 0, 2, 2,1, Qt::AlignTop);
        ...
        pGLayout->addWidget(m_pIconLable, 0, 0, 2,1, Qt::AlignTop);
        pGLayout->addWidget(m_pNameLabel, 0,1, 1,1);
        pGLayout->addWidget(m_pBubble, 1,1, 1,1);
