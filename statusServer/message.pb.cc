...
extern PROTOBUF_INTERNAL_EXPORT_message_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TextChatMsgData_message_2eproto;
namespace message {
...
class TextChatMsgDataDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<TextChatMsgData> _instance;
...
static void InitDefaultsscc_info_TextChatMsgData_message_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::message::_TextChatMsgData_default_instance_;
    new (ptr) ::message::TextChatMsgData();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::message::TextChatMsgData::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_TextChatMsgData_message_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_TextChatMsgData_message_2eproto}, {}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_TextChatMsgReq_message_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_TextChatMsgReq_message_2eproto}, {
      &scc_info_TextChatMsgData_message_2eproto.base,}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::message::TextChatMsgData, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::message::TextChatMsgData, msgid_),
  PROTOBUF_FIELD_OFFSET(::message::TextChatMsgData, msgcontent_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 125, -1, sizeof(::message::TextChatMsgData)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::message::_TextChatMsgData_default_instance_),
};
...
const char descriptor_table_protodef_message_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\001(\005\022\017\n\007fromuid\030\002 \001(\005\022\r\n\005touid\030\003 \001(\005\"Z\n\016T"
  "extChatMsgReq\022\r\n\005msgid\030\001 \001(\005\022\r\n\005touid\030\002 "
  "\001(\005\022*\n\010textmsgs\030\003 \003(\0132\030.message.TextChat"
  "MsgData\"k\n\016TextChatMsgRsp\022\r\n\005error\030\001 \001(\005"
  "\022\017\n\007fromuid\030\002 \001(\005\022\r\n\005touid\030\003 \001(\005\022*\n\010text"
  "msgs\030\004 \003(\0132\030.message.TextChatMsgData\"4\n\017"
  ...
  "ge.LoginReq\032\021.message.LoginRsp2\343\002\n\013ChatS"
  ...
  "sgRsp\"\000\022B\n\020NotifyAuthFriend\022\025.message.Ad"
  "dFriendReq\032\025.message.AddFriendRsp\"\000\022G\n\021N"
...
TextChatMsgReq::TextChatMsgReq(const TextChatMsgReq& from)
  ...
  ::memcpy(&msgid_, &from.msgid_,
    static_cast<size_t>(reinterpret_cast<char*>(&touid_) -
    reinterpret_cast<char*>(&msgid_)) + sizeof(touid_));
...
void TextChatMsgReq::InternalSwap(TextChatMsgReq* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(TextChatMsgReq, msgid_)>(
...
void TextChatMsgData::InitAsDefaultInstance() {
}
class TextChatMsgData::_Internal {
 public:
};

TextChatMsgData::TextChatMsgData(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:message.TextChatMsgData)
}
TextChatMsgData::TextChatMsgData(const TextChatMsgData& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:message.TextChatMsgData)
}

void TextChatMsgData::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_TextChatMsgData_message_2eproto.base);
  msgid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  msgcontent_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

TextChatMsgData::~TextChatMsgData() {
  // @@protoc_insertion_point(destructor:message.TextChatMsgData)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void TextChatMsgData::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
...
void TextChatMsgData::ArenaDtor(void* object) {
  TextChatMsgData* _this = reinterpret_cast< TextChatMsgData* >(object);
  (void)_this;
}
void TextChatMsgData::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void TextChatMsgData::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const TextChatMsgData& TextChatMsgData::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_TextChatMsgData_message_2eproto.base);
  return *internal_default_instance();
}


void TextChatMsgData::Clear() {
// @@protoc_insertion_point(message_clear_start:message.TextChatMsgData)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* TextChatMsgData::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "message.TextChatMsgData.msgid"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string msgcontent = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "message.TextChatMsgData.msgcontent"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* TextChatMsgData::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:message.TextChatMsgData)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->msgcontent().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "message.TextChatMsgData.msgcontent");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:message.TextChatMsgData)
  return target;
}

size_t TextChatMsgData::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:message.TextChatMsgData)
  size_t total_size = 0;
...
void TextChatMsgData::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:message.TextChatMsgData)
  GOOGLE_DCHECK_NE(&from, this);
  const TextChatMsgData* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<TextChatMsgData>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:message.TextChatMsgData)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:message.TextChatMsgData)
    MergeFrom(*source);
  }
}

void TextChatMsgData::MergeFrom(const TextChatMsgData& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:message.TextChatMsgData)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void TextChatMsgData::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:message.TextChatMsgData)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void TextChatMsgData::CopyFrom(const TextChatMsgData& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:message.TextChatMsgData)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool TextChatMsgData::IsInitialized() const {
  return true;
}

void TextChatMsgData::InternalSwap(TextChatMsgData* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata TextChatMsgData::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::message::TextChatMsgData* Arena::CreateMaybeMessage< ::message::TextChatMsgData >(Arena* arena) {
  return Arena::CreateMessageInternal< ::message::TextChatMsgData >(arena);
}
