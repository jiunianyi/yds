...
class TextChatMsgData;
class TextChatMsgDataDefaultTypeInternal;
extern TextChatMsgDataDefaultTypeInternal _TextChatMsgData_default_instance_;
...
template<> ::message::TextChatMsgData* Arena::CreateMaybeMessage<::message::TextChatMsgData>(Arena*);
...
class TextChatMsgReq PROTOBUF_FINAL :
 ...
 public:
  ...
  // repeated .message.TextChatMsgData textmsgs = 3;
  int textmsgs_size() const;
  private:
  int _internal_textmsgs_size() const;
  public:
  void clear_textmsgs();
  ::message::TextChatMsgData* mutable_textmsgs(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::message::TextChatMsgData >*
      mutable_textmsgs();
  private:
  const ::message::TextChatMsgData& _internal_textmsgs(int index) const;
  ::message::TextChatMsgData* _internal_add_textmsgs();
  public:
  const ::message::TextChatMsgData& textmsgs(int index) const;
  ::message::TextChatMsgData* add_textmsgs();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::message::TextChatMsgData >&
      textmsgs() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::message::TextChatMsgData > textmsgs_;
...
class TextChatMsgRsp PROTOBUF_FINAL :
 ...
 public:
  ...
  // repeated .message.TextChatMsgData textmsgs = 4;
  int textmsgs_size() const;
  private:
  int _internal_textmsgs_size() const;
  public:
...
class TextChatMsgData PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:message.TextChatMsgData) */ {
 public:
  inline TextChatMsgData() : TextChatMsgData(nullptr) {}
  virtual ~TextChatMsgData();

  TextChatMsgData(const TextChatMsgData& from);
  TextChatMsgData(TextChatMsgData&& from) noexcept
    : TextChatMsgData() {
    *this = ::std::move(from);
  }

  inline TextChatMsgData& operator=(const TextChatMsgData& from) {
    CopyFrom(from);
    return *this;
  }
  inline TextChatMsgData& operator=(TextChatMsgData&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const TextChatMsgData& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const TextChatMsgData* internal_default_instance() {
    return reinterpret_cast<const TextChatMsgData*>(
               &_TextChatMsgData_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    16;

  friend void swap(TextChatMsgData& a, TextChatMsgData& b) {
    a.Swap(&b);
  }
  inline void Swap(TextChatMsgData* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(TextChatMsgData* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline TextChatMsgData* New() const final {
    return CreateMaybeMessage<TextChatMsgData>(nullptr);
  }

  TextChatMsgData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<TextChatMsgData>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const TextChatMsgData& from);
  void MergeFrom(const TextChatMsgData& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(TextChatMsgData* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "message.TextChatMsgData";
  }
  protected:
  explicit TextChatMsgData(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:message.TextChatMsgData)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TextChatMsgReq::_internal_msgid() const {
  return msgid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TextChatMsgReq::msgid() const {
  // @@protoc_insertion_point(field_get:message.TextChatMsgReq.msgid)
  return _internal_msgid();
}
inline void TextChatMsgReq::_internal_set_msgid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  msgid_ = value;
}
inline void TextChatMsgReq::set_msgid(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::message::TextChatMsgData* TextChatMsgReq::mutable_textmsgs(int index) {
  // @@protoc_insertion_point(field_mutable:message.TextChatMsgReq.textmsgs)
  return textmsgs_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::message::TextChatMsgData >*
TextChatMsgReq::mutable_textmsgs() {
  // @@protoc_insertion_point(field_mutable_list:message.TextChatMsgReq.textmsgs)
  return &textmsgs_;
}
inline const ::message::TextChatMsgData& TextChatMsgReq::_internal_textmsgs(int index) const {
  return textmsgs_.Get(index);
}
inline const ::message::TextChatMsgData& TextChatMsgReq::textmsgs(int index) const {
  // @@protoc_insertion_point(field_get:message.TextChatMsgReq.textmsgs)
  return _internal_textmsgs(index);
}
inline ::message::TextChatMsgData* TextChatMsgReq::_internal_add_textmsgs() {
  return textmsgs_.Add();
}
inline ::message::TextChatMsgData* TextChatMsgReq::add_textmsgs() {
  // @@protoc_insertion_point(field_add:message.TextChatMsgReq.textmsgs)
  return _internal_add_textmsgs();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::message::TextChatMsgData >&
...
inline ::message::TextChatMsgData* TextChatMsgRsp::mutable_textmsgs(int index) {
...
inline const ::message::TextChatMsgData& TextChatMsgRsp::_internal_textmsgs(int index) const {
  return textmsgs_.Get(index);
}
inline const ::message::TextChatMsgData& TextChatMsgRsp::textmsgs(int index) const {
  // @@protoc_insertion_point(field_get:message.TextChatMsgRsp.textmsgs)
  return _internal_textmsgs(index);
}
inline ::message::TextChatMsgData* TextChatMsgRsp::_internal_add_textmsgs() {
  return textmsgs_.Add();
}
inline ::message::TextChatMsgData* TextChatMsgRsp::add_textmsgs() {
...
// string msgid = 1;
inline void TextChatMsgData::clear_msgid() {
  msgid_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& TextChatMsgData::msgid() const {
  // @@protoc_insertion_point(field_get:message.TextChatMsgData.msgid)
  return _internal_msgid();
}
inline void TextChatMsgData::set_msgid(const std::string& value) {
  _internal_set_msgid(value);
  // @@protoc_insertion_point(field_set:message.TextChatMsgData.msgid)
}
inline std::string* TextChatMsgData::mutable_msgid() {
  // @@protoc_insertion_point(field_mutable:message.TextChatMsgData.msgid)
  return _internal_mutable_msgid();
}
inline const std::string& TextChatMsgData::_internal_msgid() const {
  return msgid_.Get();
}
inline void TextChatMsgData::_internal_set_msgid(const std::string& value) {
  
  msgid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void TextChatMsgData::set_msgid(std::string&& value) {
  
  msgid_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:message.TextChatMsgData.msgid)
}
inline void TextChatMsgData::set_msgid(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  msgid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:message.TextChatMsgData.msgid)
}
inline void TextChatMsgData::set_msgid(const char* value,
    size_t size) {
  ...
  msgid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:message.TextChatMsgData.msgid)
}
inline std::string* TextChatMsgData::_internal_mutable_msgid() {
  
  return msgid_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* TextChatMsgData::release_msgid() {
  // @@protoc_insertion_point(field_release:message.TextChatMsgData.msgid)
  return msgid_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TextChatMsgData::set_allocated_msgid(std::string* msgid) {
  if (msgid != nullptr) {
  ...
  msgid_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), msgid,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:message.TextChatMsgData.msgid)
}

// string msgcontent = 2;
inline void TextChatMsgData::clear_msgcontent() {
  msgcontent_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& TextChatMsgData::msgcontent() const {
  // @@protoc_insertion_point(field_get:message.TextChatMsgData.msgcontent)
  return _internal_msgcontent();
}
inline void TextChatMsgData::set_msgcontent(const std::string& value) {
  _internal_set_msgcontent(value);
  // @@protoc_insertion_point(field_set:message.TextChatMsgData.msgcontent)
}
inline std::string* TextChatMsgData::mutable_msgcontent() {
  // @@protoc_insertion_point(field_mutable:message.TextChatMsgData.msgcontent)
  return _internal_mutable_msgcontent();
}
inline const std::string& TextChatMsgData::_internal_msgcontent() const {
  return msgcontent_.Get();
}
inline void TextChatMsgData::_internal_set_msgcontent(const std::string& value) {
  
  msgcontent_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void TextChatMsgData::set_msgcontent(std::string&& value) {
  
  msgcontent_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:message.TextChatMsgData.msgcontent)
}
inline void TextChatMsgData::set_msgcontent(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  msgcontent_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:message.TextChatMsgData.msgcontent)
}
inline void TextChatMsgData::set_msgcontent(const char* value,
    size_t size) {
  ...
  msgcontent_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:message.TextChatMsgData.msgcontent)
}
inline std::string* TextChatMsgData::_internal_mutable_msgcontent() {
  
  return msgcontent_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* TextChatMsgData::release_msgcontent() {
  // @@protoc_insertion_point(field_release:message.TextChatMsgData.msgcontent)
  return msgcontent_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void TextChatMsgData::set_allocated_msgcontent(std::string* msgcontent) {
  ...
  msgcontent_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), msgcontent,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:message.TextChatMsgData.msgcontent)
}
